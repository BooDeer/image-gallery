		...
		<div className={AuthStyles.floatContainer}>
			<div className={AuthStyles.floatChild}>
				...
				<form onSubmit={validateForm} >
					...
					<input className={AuthStyles.inputBoxes}  type="password" id="password" name="password" placeholder='********' autoComplete='on'/>
					...
					<button className={[AuthStyles.buttonStyle, AuthStyles.googleSign].join(" ")}><BsGoogle style={{display: "inline"}}/> Sign in with Google</button>
